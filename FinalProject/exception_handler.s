...
CHECK_IRQ_0: /* TIMER_RHY is interrupt level 0 */
        ...
        call TIMER_RHY_ISR /* Call TIMER_ISR */
        br   END_ISR

CHECK_IRQ_1: /* TIMER_HAR port is interrupt level 1 */
        andi r5,et,0b00010 /* Mask exception temporary with TIMER IRQ1 */
        beq  r5,r0,CHECK_IRQ_6 /* other interrupt levels are not handled in this code */
        call TIMER_HAR_ISR /* Call TIMER_ISR */
        br   END_ISR

CHECK_IRQ_6:
        andi r5,et,0b1000000 
        beq  r5,r0,END_ISR
        call KEY_ISR
        br   END_ISR
END_ISR:
